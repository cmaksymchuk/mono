...
/**
 Design an algorithm that collects daily price quotes for 
 some stock and returns the span of that stock's price 
 for the current day.
...
int next(int price) Returns the span of the stock's 
price given that today's price is price.
 */
public class StockSpanner {
	...
	public int next(int price)
	{
		...
		int nextPrice = Integer.MAX_VALUE;
		int span = 0;
